...
export class SidebarComponent {
  ...
  ngOnInit(): void {
    ...
    //      window.innerWidth > 992
    //    ) {
    //      let li = document.querySelectorAll('.main-sidemenu li');
    //      li.forEach((e, i) => {
    //        e.classList.remove('is -expanded');
    //      });
    //      let ul = document.querySelectorAll('.main-sidemenu ul');
    //      li.forEach((e, i) => {
    ...
    this.windowSubscribe$ = WindowResize.subscribe(() => {
      //  let menuWidth: any = document.querySelector<HTMLElement>('.main-sidebar');
